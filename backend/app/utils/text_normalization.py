"""Module for backend app utils text_normalization."""

import re
from typing import Any

TRANSACTION_DATE_PATTERNS: Any = [
    r"\b(?:0?[1-9]|[12]\d|3[01])[-/](?:0?[1-9]|1[0-2])[-/](?:\d{2}|\d{4})\b",
    r"\b(?:[01]?\d|2[0-3]):[0-5]\d(?:\s?(?:am|pm))?\b",
]

CARD_NUMBER_PATTERNS: Any = [
...
REFERENCE_VALUE_PATTERN: Any = r"(?:[A-Z]{2,6}\.?\s+)?(?:[\w.-]*\d[\w.-]*)"

REFERENCE_PATTERNS: Any = [
